...
const ReusableButton: React.FC<ReusableButtonProps> = ({
 ...
 const svgSizeClasses = {
  ...
  >
    ...
    <svg
      viewBox="0 0 24 24"
      className={`rounded-full transition-transform duration-300 group-hover:bg-dark-background group-hover:rotate-0 -rotate-45  ${variantClasses[variant]} ${svgSizeClasses[size]}`}
      fill="none"
