...
const Login = () => {
  ...
  return (
    <div className="bg-gray-100 py-20 flex items-center justify-center">
      <div className="flex flex-col items-center gap-4 border-2 border-gray-200 p-12 rounded-lg shadow-md w-96 mx-auto mt-10">
        <h1 className="text-2xl font-bold text-center">
          Welcome back to <br /> Drive Now
        </h1>
        ...
        <CommonForm onSubmit={onSubmit} defaultValues={defaultValues}>
          ...
          <Row justify="space-between" style={{ gap: 20 }}>
            <Button
              className="bg-primary w-full text-light-buttonText dark:text-dark-buttonText"
              htmlType="submit"
            >
              Login
            </Button>
