  ...
  return (
    <div>
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <OverviewCard title="Total Collection" value={4000}></OverviewCard>
      </section>
    </div>
  );
};
...
const OverviewCard: FC<OverviewCardProps> = ({ title, value, className }) => (
  <div className={`${className} p-7 rounded-lg shadow-lg w-full mt-4 lg:mt-0`}>
